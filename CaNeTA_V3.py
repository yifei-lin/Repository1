...
<body>
            ...
            while True:
                ...
                for adjacency_matrix in matrix_list:
                    ...
                    # Create and save combined data for this iteration
                        ...
                        output = self.calculate_degree_into_df(self._digraph_normal,conversion_time,0,stable)
    ...
    def Granularity(self):
        ...
        for i in range(0,1):
            ...
            while True:
                ...
                for adjacency_matrix in adjacency_matrix_list:
                    ...
                    # Create and save combined data for this iteration
                        ...
                        output = self.calculate_degree_into_df(self._digraph_normal,conversion_time,consistency,stable)
            ...
            KL_differences = self.calculate_kl_KS_CvM_for_dataframe(final_data)
...
### Robustness of network focusing on largest connected component
    ...
    def add_button(self):
        ...
        buttonInitial.bind("<Button-1>", lambda evt: self.plot_Digraph_initial_transparent())
        buttonInitial.pack()
